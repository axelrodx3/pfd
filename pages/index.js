...
export default function Home() {
  return (
    <>
      <Head>
        <title>Provably Fair Dice Game - Highs & Lows</title>
        <meta name="description" content="A provably fair dice game where house wins on highs and player wins on lows" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      <div className="game-container">
        <h1>�� Provably Fair Dice</h1>
        <p className="subtitle">Highs & Lows - House vs Player</p>
        
        <div className="game-info">
          <div className="rules">
            <h3>Game Rules:</h3>
            <ul>
              <li>Roll a 6-sided dice (1-6)</li>
              <li><strong>HIGH (4-6):</strong> House wins</li>
              <li><strong>LOW (1-3):</strong> Player wins</li>
              <li>Place your bet and choose your side!</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bet-section">
          <div className="bet-input">
            ...
            <input type="number" id="betAmount" min="1" max="1000" defaultValue="10" />
          </div>
          
          <div className="bet-buttons">
            <button className="bet-btn low" id="betLow">BET LOW (1-3)</button>
            <button className="bet-btn high" id="betHigh">BET HIGH (4-6)</button>
          </div>
        </div>
        ...
        <div className="provably-fair">
          <h3>�� Provably Fair</h3>
          <p><strong>Server Seed:</strong></p>
          <div className="hash-display" id="serverSeed">Generating...</div>
          <p><strong>Client Seed:</strong></p>
          <div className="hash-display" id="clientSeed">Click to generate</div>
          <p><strong>Nonce:</strong> <span id="nonce">0</span></p>
          <p><strong>Result Hash:</strong></p>
        ...
        <div className="history">
          ...
          <button className="clear-history" onClick={() => window.clearHistory()}>Clear History</button>
        </div>
      </div>
              ...
              this.gameHistory.slice(0, 10).forEach(game => {
                ...
                historyItem.innerHTML = \`
                  <div>
                    ...
                    \${game.side.toUpperCase()} - $\${game.betAmount}
                  </div>
                  <div>
