...
import { X, Dice1, TrendingUp, TrendingDown, Info, Trophy, Zap } from 'lucide-react'
            ...
            <div className="p-6 space-y-6">
              ...
              <section>
                ...
                <p className="text-gray-300 leading-relaxed">
                  Predict whether the dice will roll HIGH (4-6) or LOW (1-3). 
                  If you guess correctly, you win! The game uses a 1.98x multiplier 
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white mb-1">Set Your Bet</h4>
                      <p className="text-gray-300 text-sm">
                        Choose your bet amount using the input field or quick bet buttons. 
                        You can bet between 1 and your total HILO tokens.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">
                        Select either HIGH (4-6) or LOW (1-3) to predict the dice outcome.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white mb-1">Roll the Dice</h4>
                      <p className="text-gray-300 text-sm">
                        Click the "Roll Dice" button and watch the 3D dice animation. 
                        The dice will land on a number between 1-6.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white mb-1">Collect Winnings</h4>
                      <p className="text-gray-300 text-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-semibold text-green-400">HIGH (4-6)</h4>
                    </div>
                    <p className="text-gray-300 text-sm">
                      Bet that the dice will land on 4, 5, or 6. 
                      Win rate: ~49% (accounting for house edge)
                    </p>
                  </div>
                  ...
                  <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
                    ...
                    <p className="text-gray-300 text-sm">
                      Bet that the dice will land on 1, 2, or 3. 
                      Win rate: ~49% (accounting for house edge)
                    </p>
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-hilo-gold rounded-full mt-2 flex-shrink-0" />
                    <p className="text-gray-300 text-sm">
                      Remember: This is a mock casino - no real money is involved!
                    </p>
                  </div>
                </div>
              </section>
