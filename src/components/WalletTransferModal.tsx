...
export const WalletTransferModal: React.FC<WalletTransferModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} maxWidth="md" title={transferType === 'deposit' ? 'Deposit to Game' : 'Withdraw from Game'}>
      <div className="relative w-full bg-hilo-gray border border-hilo-gray-light rounded-2xl">
