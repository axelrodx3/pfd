...
import { clusterApiUrl, PublicKey, Transaction, TransactionInstruction, SystemProgram, Connection } from '@solana/web3.js';
...
const WalletContextInner: React.FC<{ 
  ...
  const { publicKey, connected, connecting, wallet, connect, disconnect, signMessage: walletSignMessage } = useWallet();
