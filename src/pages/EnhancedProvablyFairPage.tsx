    ...
    <div className="min-h-screen bg-hilo-black text-white p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-hilo-gold mb-4">Provably Fair Gaming</h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Complete transparency in every roll. Verify the fairness of our games using cryptographic proofs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl font-bold text-hilo-gold mb-4">House Edge</h2>
            ...
            {houseEdgeInfo && (
              <div className="space-y-4">
                ...
                <div className="bg-hilo-gold/10 border border-hilo-gold rounded-lg p-4">
                  <h3 className="font-bold text-hilo-gold mb-2">Why House Edge?</h3>
          ...
          >
            <h2 className="text-2xl font-bold text-hilo-gold mb-4">Current Seeds</h2>
          ...
          >
            <h2 className="text-2xl font-bold text-hilo-gold mb-4">Verify Roll</h2>
          ...
          >
            <h2 className="text-2xl font-bold text-hilo-gold mb-4">Recent Rolls</h2>
            ...
            <div className="space-y-2 max-h-64 overflow-y-auto">
              ...
              {gameHistory.length === 0 && (
                <div className="text-center text-gray-400 py-8">
                  ...
                  <div className="text-sm">Start playing to see your roll history</div>
                </div>
              )}
            </div>
          </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold text-hilo-gold mb-4">Fairness Guarantee</h2>
          <p className="text-lg text-gray-300 mb-6 max-w-3xl mx-auto">
            Every roll is cryptographically verifiable. We use industry-standard hashing algorithms 
            to ensure complete transparency and fairness. You can verify any roll at any time.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="text-center">
              <div className="text-4xl mb-2">🔒</div>
              <h3 className="font-bold text-white mb-2">Cryptographically Secure</h3>
              <p className="text-sm text-gray-400">
            ...
            <div className="text-center">
              <div className="text-4xl mb-2">✅</div>
              <h3 className="font-bold text-white mb-2">Independently Verifiable</h3>
              <p className="text-sm text-gray-400">
