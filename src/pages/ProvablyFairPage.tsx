...
export const ProvablyFairPage: React.FC = () => {
  const { serverSeed, clientSeed, nonce, gameHistory, verifyRoll } =
    useGameStore()
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Provably fair gaming ensures that every game result is transparent
              and verifiable. Our system uses cryptographic hashing to guarantee
              that:
            </p>
            ...
            <div className="bg-hilo-red/10 border border-hilo-red/30 rounded-lg p-4 mt-6">
              <p className="text-hilo-red font-semibold">
                ⚠️ This is a demonstration of provably fair mechanics. In a real
                implementation, these would be cryptographically secure hashes.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-hilo-gold mb-2">
                1. Server Seed
              </h3>
          ...
          {gameHistory.length > 0 ? (
            <div className="space-y-4">
              <div className="bg-hilo-gray-light p-4 rounded-lg">
                <h3 className="font-semibold text-hilo-gold mb-2">
                  Last Game Details
                </h3>
