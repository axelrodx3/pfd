...
test.describe('Solana Wallet Integration', () => {
  ...
  test('should display wallet connection interface', async ({ page }) => {
    ...
    await expect(page.locator('text=Connecting your wallet only proves ownership')).toBeVisible();
    await expect(page.locator('text=no funds can be accessed without your confirmation')).toBeVisible();
  });
  ...
  test('should show security warnings and disclaimers', async ({ page }) => {
    ...
    await expect(page.locator('text=Connecting only proves ownership')).toBeVisible();
    await expect(page.locator('text=Never request access to your private keys')).toBeVisible();
  ...
  test('should validate transaction inputs', async ({ page }) => {
    ...
    // Test invalid inputs
    await page.fill('input[placeholder="Enter Solana address"]', 'invalid-address');
  ...
  test('should handle transaction confirmation', async ({ page }) => {
    ...
    await page.fill('input[placeholder="Enter Solana address"]', '22222222222222222222222222222222');
    await page.fill('input[placeholder="0.001"]', '0.1');
